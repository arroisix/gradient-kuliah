...
// Calculated as: left = x/960*100%, top = y/285*100%
  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div className="relative max-w-[1280px] mx-auto px-6 md:px-[60px] pt-48 pb-16 md:pt-56 md:pb-24">
        ...
        {/* Aspect ratio 960:285 from Figma, overflow visible for edge pins */}
        <div className="relative w-full max-w-[960px] mx-auto aspect-[960/285] mb-12 overflow-visible">
          ...
          {/* University pins - positions are for top-left corner */}
          {universityPins.map((pin) => (
            ...
            >
              ...
              <Image
                ...
                alt=""
                fill
                className="absolute drop-shadow-[0px_4px_4px_rgba(0,0,0,0.25)]"
              />
              {/* University logo */}
        ...
        <div className="relative flex flex-col items-center gap-4 text-center">
          <h2 className="text-[24px] md:text-[30px] font-bold text-white leading-[1.2]">
            <span className="relative inline-block isolate">
              ...
              <span
                className="absolute -left-2 right-0 top-[45%] bottom-[-4px] bg-primary-purple -z-10"
                style={{ transform: "skewX(-12deg)" }}
              />
              <span className="relative z-10">200.000+ pelajar</span>
            </span>{" "}
            di Indonesia menggunakan Gradient
          </h2>

          <p className="text-gray-text text-base leading-normal">
            Satu langkah menuju nilai yang lebih baik
          </p>

          <button className="mt-2 px-5 py-3 h-[52px] bg-primary-purple hover:bg-primary-purple/90 text-white text-base font-semibold rounded-full transition-colors">
            Daftar Sekarang
          </button>
        </div>
      </div>
