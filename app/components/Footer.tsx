...
export default function Footer() {
  return (
    <footer className="w-full bg-bg-card pt-8 pb-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-12">
          ...
          <div className="flex flex-wrap gap-6">
            ...
            <div className="flex flex-col gap-3 w-[152px]">
              ...
              <div className="flex flex-col gap-2">
                {footerLinks.tentangKami.links.map((link, index) => (
                  <Link
                    key={index}
                    href={link.href}
            ...
            <div className="flex flex-col gap-3 w-[152px]">
              ...
              <div className="flex flex-col gap-2">
                {footerLinks.panduan.links.map((link, index) => (
                  <Link
                    key={index}
                    href={link.href}
                    className="text-[#999] hover:text-white transition-colors text-sm leading-[1.6]"
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-2">
                {footerLinks.produkGradient.links.map((link, index) => (
                  <Link
                    key={index}
                    href={link.href}
                    className="text-[#999] hover:text-white transition-colors text-sm leading-[1.6]"
          ...
          <div className="flex flex-col sm:flex-row gap-12">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-2">
                {contactInfo.map((contact, index) => (
                  ...
                  >
                    <contact.icon className="w-5 h-5 text-primary-purple" />
                    {contact.label}
                  </Link>
                ))}
              </div>
            ...
            <div className="flex flex-col gap-6 w-full sm:w-[359px]">
              {/* Brand Name */}
              <h2 className="font-urbanist font-extrabold text-2xl text-white">
                Gradient
              </h2>
              ...
              <div className="flex gap-6">
                ...
                <Link
                  href="#"
                  className="flex items-center gap-3 bg-primary-purple hover:bg-primary-purple/90 transition-colors rounded-xl px-3 py-2 h-[61px] w-[169px]"
                >
                  <svg
                    className="w-7 h-8"
                    viewBox="0 0 24 24"
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1 text-[#999] text-xs leading-[1.6]">
                  <p>Smesco SME Tower Kontrak Hukum Office Space Lt. 6</p>
                  <p>
                    Jl. Gatot Subroto Kav. 94, RT.11/RW.3, Kel. Pancoran, Kec.
