...
const TextbookHierarchy: React.FC<TextbookHierarchyProps> = ({
            ...
            <>
                {problemsData.data.map(problem => (
                    <button
                        ...
                        className={cn(
                            'w-full flex items-center gap-2 px-3 py-1.5 ml-4 rounded-lg transition-colors text-left',
                            'hover:bg-white/5',
    ...
    return (
        <div className="relative">
            ...
            <div className="fixed bottom-4 left-4 right-4 bg-[#2C2C2C] border border-transparent rounded-xl p-4 flex items-center gap-3 mx-16 mb-8">
                <div className="relative aspect-[256/364] h-12 flex-shrink-0">
                    <Image
                        ...
                        objectFit="cover"
                        className="rounded border border-neutral-700 shadow-lg"
                    />
                </div>
