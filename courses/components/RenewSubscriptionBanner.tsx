...
export default function RenewSubscriptionBanner({
    ...
    return (
        <div className={cn('fixed md:bottom-[32px] z-[15] left-[12px] right-[12px] md:right-[36px] bg-[#B73E32] px-4 md:px-6 py-3 md:py-4 rounded-lg', is_subscribed? 'bottom-[85px] md:left-[286px]' : 'bottom-[16px] md:left-[36px]')}>
