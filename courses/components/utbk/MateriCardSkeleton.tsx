function MateriCardSkeleton() {
    return (
        <div className="bg-[#222222] animate-pulse w-full rounded-lg p-4 flex gap-4 items-center">
            ...
            <div className="flex-grow">
                ...
                <div className="h-4 w-full bg-[#333333] rounded-md mb-2" />
                <div className="h-2 w-full bg-[#333333] rounded-full mb-4"></div>
