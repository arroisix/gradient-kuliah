...
import { capitalize, cn, slugify } from 'commons/utils';
...
const AstronotesDetail = ({
    ...
    return (
        <>
            ...
            <div
                className={cn(
                    'grid grid-cols-1 gap-4 lg:pb-16 mx-auto 2xl:max-w-screen-2xl lg:grid-cols-3'
                )}>
                <div
                    className={cn(
                        'flex flex-col w-full gap-4 mb-8 md:gap-6 lg:col-span-2'
                    )}>
                    <Tabs />
...
const Tabs = (): JSX.Element => {
    ...
    const tabStyle = (tabKey: 'details' | 'contents'): string =>
        cn(
            'text-center text-sm py-3 border-b-2 flex-1 md:flex-none whitespace-nowrap',
    ...
    return (
        <div className="z-[5] flex items-end w-full pb-2 overflow-x-auto bg-black top-14 no-scrollbar">
            <div
                className={cn(
