...
function PeluangCard({
    ...
    return (
        <div className="bg-[#101010] space-y-4 rounded-xl py-3 px-4 mb-6">
            <div className="w-full max-w-[416px] mx-auto space-y-4">
                ...
                <div className="flex items-center gap-4">
                    <div className="flex-grow bg-[#222222] border border-[#2C2C2C] rounded-xl p-4 space-y-1">
                    ...
                    <div className="bg-[#222222] border border-[#2C2C2C] rounded-xl p-4 space-y-1">
                        <h3 className="text-[#999999] text-xs leading-[160%]">
                            Peluang Lolos
                        </h3>
