    ...
    return (
        <div className="bg-[#222222] md:bg-[#101010]">
            <Container
                ...
                <div className={cn('relative w-full', isAuthenticated? 'aspect-[710/325] bg-[#33354080]/[0.5] rounded-3xl overflow-hidden lg:w-3/5' : 'aspect-[625/372] lg:w-1/2')}>
                    <Image
                        src={isAuthenticated? `${CDN_URL}/assets/landing-registered-hero.png` : `${CDN_URL}/assets/landing-unregistered-hero.png`}
                        priority
                        layout="fill"
                        alt="hero"
                    />
