...
const PricingCard = ({ plan }: { plan: PricingPlan }): JSX.Element => {
    ...
    return (
        ...
        ${featured ? 'border-2 border-accent-purple/50' : 'bg-[#222]'}
      `}
            style={
                featured
                    ? {
            ...
            {/* Featured badge */}
            {featured && (
                <div className="w-full bg-accent-purple/50 py-2.5 rounded-t-xl text-center">
            ...
            {/* Content */}
            <div
                className={`flex flex-col gap-4 w-full ${!featured ? 'pt-6' : ''}`}>
                {/* Pricing header */}
                <div className="flex flex-col gap-1 items-center w-full">
                    ...
                    <p
                        className={`font-extrabold text-[32px] leading-tight ${
                            featured
                    ...
                    <div className="relative">
                        <span className="font-bold text-lg text-[#666]">
                            {originalPrice}
                        </span>
                ...
                <div className="flex flex-col gap-2.5 px-6">
                    {features.map((feature, index) => (
                        <div key={index} className="flex gap-3 items-center">
                            <div className="flex items-center justify-center w-6 h-6 rounded-full bg-accent-purple/20">
            ...
            <div className="w-full px-6 pb-6">
                <button className="w-full py-2 px-6 bg-accent-purple hover:bg-accent-purple/90 text-white font-bold text-sm rounded-full transition-colors">
                    Langganan Sekarang
                </button>
            </div>
        </div>
            ...
            <div className="max-w-[1280px] mx-auto px-6 md:px-[60px]">
                <div className="flex flex-col gap-10 items-center">
                    ...
                    <h2 className="text-[32px] md:text-[64px] font-bold text-white text-center leading-[1.25]">
                        Tertarik? Langganan untuk mengakses seluruh materi di Gradient Kuliah.
                    </h2>
                    <p className="text-lg text-neutral-400 leading-relaxed text-center">
                        Daftar langganan hanya berlaku untuk Gradient Kuliah
                    </p>
