...
const TestimonyCard = ({
    ...
    return (
        <div
            ...
            style={{
                background:
                    'linear-gradient(133deg, rgb(26, 26, 26) 0%, rgb(10, 10, 10) 100%)'
            }}>
            {/* Quote */}
...
const TestimonySection = (): JSX.Element => {
    return (
        <section className="relative w-full bg-black py-16 md:py-24 overflow-hidden">
            ...
            <div
                ...
                style={{
                    background:
                        'radial-gradient(ellipse at center, rgba(95, 43, 206, 0.3) 0%, transparent 70%)'
                }}
            />
