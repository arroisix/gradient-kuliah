...
export const getStaticProps: GetStaticProps = wrapper.getStaticProps(
    (store) =>
        async ({ params }) => {
            ...
            const title = bankSoal.problem.title.length > 70? `${bankSoal.problem.title.substring(0, 70)} ...` : bankSoal.problem.title
            const description = 'Persiapkan diri kamu untuk menghadapi ujian dengan kumpuan soal-soal UTS, UAS, ujian, dan bank soal dari universitas ternama. Pelajari setiap soal dengan detail!'
